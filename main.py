...
from gifos.modules.hackedTextEffect import hackedTextEffectLines
...
fontFileTruetype = "./fonts/coolville.regular.ttf"
fontFileBitmap = "./fonts/cherry-13-r.pil"
# fontTruetype = ImageFont.truetype(fontFileTruetype, size=60)  # truetype font
...
#     t.genMultiText(lines3, t.currRow + 1, 1, 10)
    ...
    # userDetails = calcUserStats("MartinHeinz", includeAllCommits=True)
    # ic(userDetails)
    ...
    lines = hackedTextEffectLines("G I F  O S", 5, True)
    t.toggleShowCursor(False)
    for line in lines:
        t.deleteRow(5)
        t.genText(line, 5, 1)
